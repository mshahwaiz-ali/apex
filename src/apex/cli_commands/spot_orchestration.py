"""CLI command for provider-independent end-to-end spot orchestration."""
...
def register_spot_orchestration_commands(app: typer.Typer) -> None:
    """Register strict provider-independent spot orchestration."""

    @app.command("spot-orchestrate")
    def spot_orchestrate(
