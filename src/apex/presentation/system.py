        ...
        render_section(
            ...
            render_fields(
                (
                    ...
                    ("Spread percentage", format_percentage(spread_pct)),
...
def render_config(payload: Mapping[str, object], *, mode: str | OutputMode = "text") -> str:
        ...
        render_section(
            ...
            render_fields(
                (
                    ...
                    ("Provider", humanize_code(payload.get("provider"))),
