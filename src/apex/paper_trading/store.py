...
def _trade_from_payload(payload: Any) -> PaperTrade:
    ...
    signal = BacktestSignal(
        ...
        target_prices=tuple(signal_payload.get("target_prices", ())),
        partial_close_percentages=tuple(signal_payload.get("partial_close_percentages", ())),
    )
    return PaperTrade(
        ...
        lifecycle_events=tuple(payload.get("lifecycle_events", ())),
        ...
        partial_target_count=payload.get("partial_target_count", 0),
        closed_percentage=payload.get("closed_percentage", 0.0),
