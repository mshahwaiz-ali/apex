...
class FuturesScanSelection:
    ...
    def __post_init__(self) -> None:
        if not self.symbols:
            raise ValueError(
                "futures scan selection cannot be empty"
            )
...
def select_futures_scan_symbols(
    ...
    *,
    ...
    market_symbols = {
        _normalize_symbol(contract.exchange_symbol): contract.symbol
        ...
        "candidates": [
            {
                ...
                "opportunity_score": (
                    candidate.opportunity.total
                ),
                "opportunity_components": {
                    "liquidity": (
                        candidate.opportunity.liquidity
                    ),
                    "movement": candidate.opportunity.movement,
                    "acceleration": (
                        candidate.opportunity.acceleration
                    ),
                    "relative_volume": (
                        candidate.opportunity.relative_volume
                    ),
                    ...
                    "entry_freshness": (
                        candidate.opportunity.entry_freshness
                    ),
                    "structure_proximity": (
                        candidate.opportunity
                        .structure_proximity
                    ...
                    "spread_quality": (
                        candidate.opportunity.spread_quality
                    ),
                    "noise_quality": (
                        candidate.opportunity.noise_quality
                    ),
                },
                "features": {
                    "return_5m_pct": (
                        candidate.features.return_5m_pct
                    ),
                    "return_15m_pct": (
                        candidate.features.return_15m_pct
                    ),
                    "return_30m_pct": (
                        candidate.features.return_30m_pct
                    ),
                    "return_1h_pct": (
                        candidate.features.return_1h_pct
                    ),
                    "relative_volume": (
                        candidate.features.relative_volume
                    ),
                    "volume_acceleration": (
                        candidate.features.volume_acceleration
                    ),
                    "atr_percentage": (
                        candidate.features.atr_percentage
                    ),
                    "range_expansion": (
                        candidate.features.range_expansion
                    ),
                    ...
                    "breakout_proximity": (
                        candidate.features.breakout_proximity
                    ),
                    "ema_distance_atr": (
                        candidate.features.ema_distance_atr
                    ),
                    "wick_intensity": (
                        candidate.features.wick_intensity
                    ),
                ...
                "cautions": list(
                    candidate.opportunity.cautions
                ),
                "quote_volume_24h": (
